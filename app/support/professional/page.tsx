...
const pathways = [
  ...
  {
    eyebrow: "SCHOOL + PROGRAM SUPPORT",
    title: "Use an existing professional support network.",
    body: "Schools, teams, colleges, youth programs, and community organizations can connect Z-Girl preparation to their own authorized counseling and support resources without giving Z-Girl clinical authority.",
    cta: "Explore institutional access",
    href: "/partners",
  },
  {
