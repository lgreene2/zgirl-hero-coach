      ...
      <div className="w-full max-w-3xl rounded-3xl bg-slate-900/80 border border-slate-800 shadow-2xl shadow-cyan-500/10 px-6 py-6 md:px-10 md:py-8 space-y-6">
        ...
        <header className="space-y-2">
          ...
          <p className="text-sm text-slate-300 max-w-2xl">
            ...
            moves” for their everyday life. This page explains what the app is,
            what it is not, and how we encourage it to be used safely.
          </p>
        </header>

        {/* Section: What Z-Girl Is */}
        <section className="space-y-2">
          ...
          <ul className="list-disc list-inside space-y-1 text-sm text-slate-300">
            <li>
              A <span className="font-semibold">fictional hero coach</span>{" "}
              based on the world of <span className="font-semibold">The 4 Lessons</span>.
            </li>
            <li>
            ...
            <li>
              A space to practice simple coping skills like breathing, grounding,
              positive self-talk, and choosing small “hero moves.”
            </li>
            <li>
        ...
        {/* Section: How Z-Girl Responds to Difficult Topics */}
        <section className="space-y-2">
          <h2 className="text-lg font-semibold text-slate-100">
            How Z-Girl Responds to Difficult Topics
          </h2>
          <p className="text-sm text-slate-300">
            Z-Girl is designed to respond gently and carefully when users bring
            up serious or frightening situations, including:
          </p>
          <ul className="list-disc list-inside space-y-1 text-sm text-slate-300">
            <li>Self-harm, suicide, or wanting to die</li>
            <li>Serious thoughts about hurting someone else</li>
            <li>Abuse, assault, or feeling unsafe at home, school, or online</li>
          </ul>
          <p className="text-sm text-slate-300">
          ...
          <ul className="list-disc list-inside space-y-1 text-sm text-slate-300">
            ...
            <li>
              ...
              <span className="font-semibold">
                only a digital hero coach, not an emergency service
              </span>
              .
            </li>
            <li>
            ...
            <li>
              If there seems to be immediate danger, encourages the user to
              contact local emergency services (for example,{" "}
        ...
        {/* Section: Guidance for Parents & Educators */}
        <section className="space-y-2">
          <h2 className="text-lg font-semibold text-slate-100">
          ...
          <ul className="list-disc list-inside space-y-1 text-sm text-slate-300">
            <li>
              You may want to try the app yourself first, so you understand how
              Z-Girl talks and what she focuses on.
            </li>
            <li>
              Invite young people to share how they feel after using the app and
              what “hero moves” they’d like support with.
            </li>
            <li>
              Remind youth that it’s always okay to ask for help in real life,
              even if Z-Girl feels comforting or easy to talk to.
            </li>
            <li>
              For school / program use, Z-Girl can be paired with classroom
              SEL lessons, journaling activities, or small-group discussions.
            </li>
          </ul>
        </section>
        ...
        <section className="space-y-2">
          ...
          <p className="text-sm text-slate-300">
            ...
            accounts. Conversations are stored locally in the browser so that
            the user can see past chats and saved “Hero Moments.”
          </p>
          <ul className="list-disc list-inside space-y-1 text-sm text-slate-300">
            <li>
              Clearing the chat inside the app will remove the visible
              conversation from that device.
            </li>
            <li>
              Clearing the browser&apos;s local data or using private / incognito
              mode may remove stored conversations.
            </li>
            <li>
              As the app grows, more detailed privacy information may be added
              here or on a separate policy page.
            </li>
          </ul>
        </section>

        {/* Section: When in Doubt, Reach Out */}
        <section className="space-y-2">
          <h2 className="text-lg font-semibold text-slate-100">
          ...
          <p className="text-sm text-slate-300">
            ...
            hopeful—but real-life heroes are essential too. If you are worried
            about a young person in your life, please connect them with a
            trusted adult, school support, or professional help in your
            community.
          </p>
        </section>
