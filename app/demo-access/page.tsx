      ...
      <section className="mx-auto max-w-5xl px-5 py-14 sm:px-8 lg:px-12 lg:py-20">
        <div className="overflow-hidden rounded-[2.2rem] border border-[#49d8c2]/20 bg-[#0b2030] shadow-2xl shadow-black/25">
          <div className="border-b border-white/10 bg-gradient-to-r from-[#49d8c2]/10 via-transparent to-[#ff4fb8]/10 p-7 sm:p-10">
            ...
            <p className="mt-5 max-w-3xl text-base leading-8 text-slate-300 sm:text-lg">The public experience is for exploration and sample scenarios. Live supporter handoffs, participant follow-up records, and restricted operational tools require an approved access path.</p>
          </div>
          <div className="grid gap-5 p-7 sm:grid-cols-2 sm:p-10">
            <div className="rounded-3xl border border-white/10 bg-white/[.035] p-6"><p className="text-xs font-black uppercase tracking-[.18em] text-[#76ead6]">Available in demo</p><h2 className="mt-2 text-2xl font-black">See how Z-Girl works.</h2><p className="mt-3 text-sm leading-7 text-slate-400">Explore the product story, human-support model, market experiences, and sample reflection pathways without creating a live supporter record.</p><Link href="/" className="button-primary mt-6 !min-h-0">Continue exploring →</Link></div>
            <div className="rounded-3xl border border-white/10 bg-white/[.035] p-6"><p className="text-xs font-black uppercase tracking-[.18em] text-[#ff8bd0]">Approved access</p><h2 className="mt-2 text-2xl font-black">Ready for real use?</h2><p className="mt-3 text-sm leading-7 text-slate-400">Secure sharing, supporter responses, pilots, and customer/institutional activation use separate governed access paths.</p><div className="mt-6 flex flex-wrap gap-3"><Link href="/pilot" className="button-primary !min-h-0">Request pilot access</Link><Link href="/support/visual-system" className="button-secondary !min-h-0">Explore human support</Link></div></div>
          </div>
