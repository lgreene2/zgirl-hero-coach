    ...
    <main className="min-h-screen bg-slate-950 text-slate-50 flex justify-center px-4 py-10">
      <div className="w-full max-w-3xl space-y-6 rounded-3xl bg-slate-900/80 border border-slate-800 px-6 py-8 shadow-xl">
        <header className="space-y-2">
          ...
          <div className="mt-3 rounded-2xl border border-emerald-400/30 bg-emerald-400/10 px-4 py-3 text-xs leading-5 text-emerald-100">
            <strong>Updated institutional package:</strong> Z-Girl EDU now provides the current privacy, implementation, accessibility, safety, and aggregate-outcomes framework. <Link href="/edu" className="font-black underline underline-offset-2">Review Z-Girl EDU →</Link>
          </div>
        </header>
        ...
        <section className="rounded-2xl bg-sky-500/10 border border-sky-500/30 p-4 space-y-2">
          ...
          <p className="text-sm text-slate-200">
            Z-Girl is not therapy, medical care, or emergency support. AI Coach messages are sent to the application and AI provider to generate replies. Private Reflection does not use the AI provider. Sensitive topics trigger a safety response and encourage real-world support.
          </p>
        </section>
