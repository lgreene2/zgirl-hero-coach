...
export default function PilotClient({
  ...
  function handleSubmit() {
    setSubmitted(true);
    router.replace("/pilot?submitted=1"); // keeps the URL state for share/refresh
    window.location.href = mailtoHref;   // opens the email draft
  }
          ...
          {submitted ? (
            <div className="rounded-2xl border border-emerald-500/30 bg-emerald-500/10 p-4">
              ...
              <p className="mt-1 text-sm text-slate-200">
                If your email didn’t open automatically, click below:
              </p>
              <a
