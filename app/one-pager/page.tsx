...
export default function OnePagerPage() {
  return <main className="min-h-screen bg-[#061521] text-white"><SiteHeader /><div className="mx-auto max-w-5xl px-5 py-12 sm:px-8 lg:py-16">
    <div className="flex flex-wrap items-center gap-2"><span className="eyebrow">Z-Girl Open</span><span className="eyebrow eyebrow-muted">Current public overview</span></div>
