      ...
      <header className="relative z-30 border-b border-white/10 bg-[#061521]/90 backdrop-blur-xl">
        <div className="mx-auto flex max-w-7xl items-center justify-between gap-2 px-4 py-4 sm:gap-4 sm:px-8 lg:px-12">
          <Link href="/" className="flex min-w-0 shrink items-center gap-2 sm:gap-3" aria-label="Z-Girl home">
            ...
            <span className="min-w-0"><span className="flex items-center gap-2"><span className="block truncate font-display text-base font-black leading-none sm:text-lg">Z-Girl</span><span className="rounded-full border border-[#49d8c2]/25 bg-[#49d8c2]/10 px-2 py-0.5 text-[9px] font-black uppercase tracking-[.14em] text-[#9af3e4]">Demo</span></span><span className="mt-1 hidden text-[10px] font-bold uppercase tracking-[.18em] text-[#76ead6] sm:block">Hero Within</span></span>
          </Link>
          <nav aria-label="Primary navigation" className="hidden items-center gap-3 text-xs font-bold text-slate-300 md:flex lg:gap-5 lg:text-sm">
            ...
            <Link href="/support/adaptive" className="hidden transition hover:text-white xl:inline">Adaptive</Link>
            <Link href="/journey" className="transition hover:text-white">Journey</Link>
            <Link href="/faith" className="transition hover:text-white">Faith</Link>
            ...
            <Link href="/store" className="hidden transition hover:text-white xl:inline">Store</Link>
          </nav>
          <div className="flex shrink-0 items-center gap-2">
            <Link href="/demo-access" className="hidden rounded-full border border-white/15 px-3 py-2.5 text-[11px] font-black text-slate-200 sm:inline-flex md:hidden">Access</Link>
            <Link href="/support" className="rounded-full border border-[#49d8c2]/45 bg-[#49d8c2]/10 px-3 py-2.5 text-[11px] font-black text-[#9af3e4] transition hover:border-[#76ead6] hover:bg-[#49d8c2]/15 md:hidden">Support</Link>
            <Link href="/reflect" className="rounded-full bg-[#49d8c2] px-3 py-2.5 text-[11px] font-black text-[#04151c] transition hover:bg-[#76ead6] sm:px-4 sm:text-sm"><span className="sm:hidden">Reflect</span><span className="hidden sm:inline">Try reflection</span></Link>
          </div>
        </div>
      </header>
