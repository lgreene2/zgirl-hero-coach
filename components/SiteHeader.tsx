      ...
      <header className="relative z-30 border-b border-white/10 bg-[#061521]/90 backdrop-blur-xl">
        <div className="mx-auto flex max-w-7xl items-center justify-between gap-2 px-4 py-4 sm:gap-4 sm:px-8 lg:px-12">
          ...
          <nav aria-label="Primary navigation" className="hidden items-center gap-3 text-xs font-bold text-slate-300 md:flex lg:gap-5 lg:text-sm">
            ...
            <Link href="/demo-access" className="transition hover:text-white">Access</Link>
          ...
          <div className="flex shrink-0 items-center gap-2">
            <Link href="/demo-access" className="rounded-full border border-[#49d8c2]/45 bg-[#49d8c2]/10 px-3 py-2.5 text-[11px] font-black text-[#9af3e4] transition hover:border-[#76ead6] hover:bg-[#49d8c2]/15 md:hidden">Access</Link>
            <Link href="/support" className="hidden rounded-full border border-white/15 px-3 py-2.5 text-[11px] font-black text-slate-200 sm:inline-flex md:hidden">Support</Link>
