...
const contexts = {
  ...
  athlete: { src:"https://images.unsplash.com/photo-1517466787929-bc90951d0974?auto=format&fit=crop&w=1400&q=85", eyebrow:"Athlete + trusted support", title:"The next play can include a conversation.", copy:"Reflect privately, then choose whether a coach, parent, teammate, or trusted adult can help you move forward.", href:"/support/adaptive", cta:"Choose support" },
  faith: { src:"https://images.unsplash.com/photo-1520857014576-2c4f4c972b57?auto=format&fit=crop&w=1400&q=85", eyebrow:"Values + community", title:"Reflection can lead back to people you trust.", copy:"Prepare your thoughts privately, then choose whether a family member, faith leader, mentor, or trusted adult belongs in the next conversation.", href:"/support/adaptive", cta:"Prepare a conversation" },
...
export default function HumanContextStrip({variant}:{variant:keyof typeof contexts}){
  ...
  return <section className="relative overflow-hidden rounded-[2rem] border border-white/10 bg-[#0b2030] shadow-2xl shadow-black/20">
    <div className="relative min-h-[300px] sm:min-h-[340px]">
      <Image src={item.src} alt="People connecting in a supportive real-world setting" fill className="object-cover" sizes="(max-width: 1200px) 100vw, 1200px" />
